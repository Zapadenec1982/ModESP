...
#define CONFIG_USE_ASYNC_SAVE 1
#define CONFIG_ASYNC_SAVE_QUEUE_SIZE 20
#define CONFIG_ASYNC_SAVE_BATCH_DELAY_MS 200
#define CONFIG_ASYNC_SAVE_WATCHDOG_FEED_MS 30
