...
/**
 * @brief Register modules from manifest files
 * 
 * Automatically registers modules based on manifest data.
 * Validates dependencies and registers in correct order.
 * Skips already registered modules.
 * 
 * @return ESP_OK on success
 */
...
/**
 * @brief Set the heartbeat monitor instance for ModuleManager to use
 *
 * @param monitor Pointer to the ModuleHeartbeat instance
 */
